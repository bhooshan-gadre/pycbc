...
def _get_imr_duration(m1, m2, s1z, s2z, f_low, approximant="SEOBNRv4",
    ...
    if approximant == "SEOBNRv2":
        ...
        time_length = get_XE_chirptime(m1, m2, s1z, s2z, \
                eccentricity, mean_per_ano, fref, f_low)
    else:

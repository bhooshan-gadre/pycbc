...
class JobSegmenter(object):
    ...
    def __init__(self, data_lengths, valid_chunks, valid_lengths, curr_seg,
        ...
        if self.data_loss < 0:
            raise ValueError(
                "pycbc.workflow.jobsetup needs fixing! Please contact a developer")
...
class PyCBCInspiralExecutable(Executable):
    ...
    def get_valid_times(self):
        ...
        for nsegs in seg_ranges:
            ...
            if data_length > max_analysis_length:
                continue
            if data_length < min_analysis_length:
                continue
